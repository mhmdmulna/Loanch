    ...
    <NetworkGuard>
      <div className="loanch-page">
        ...
        <main className="loanch-container space-y-8 py-8 sm:py-10">
          ...
          <section className="grid gap-5 lg:grid-cols-2"><Card><CardContent><div className="loanch-eyebrow mb-2">Financial reputation</div><h3 className="text-lg font-semibold text-slate-100">Profile unavailable</h3><p className="mt-2 text-sm leading-relaxed text-slate-400">Reputation details are not connected in this demo.</p><Button variant="secondary" size="small" className="mt-5" disabled>View profile</Button></CardContent></Card><Card><CardContent><div className="loanch-eyebrow mb-2">Blockchain transparency</div><h3 className="text-lg font-semibold text-slate-100">Network details unavailable</h3><p className="mt-2 text-sm leading-relaxed text-slate-400">Network values use the configuration provided for this environment.</p><Button variant="secondary" size="small" className="mt-5" disabled>Inspect details</Button></CardContent></Card></section>
